  ...
  const completionMessages: GigaChatMessage[] = [
    {
      role: 'system',
      content:
        'Ты составляешь заголовок для списка тестов в приложении. По описанию или переписке пользователя про языковое обучение придумай короткое название на русском: 3–10 слов, без кавычек, без префиксов вроде «Название:». Отрази тему или язык/уровень, если они явно есть. Одна строка — только заголовок.',
    },
    {
      role: 'user',
